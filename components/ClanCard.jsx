...
export default function ClanCard({ clan, isDark, THEME = { card: '#0a0a0a', text: '#ffffff', border: '#262626', accent: '#3b82f6' } }) {
    ...
    const CardInner = (
        <View
            className="relative p-8 bg-white dark:bg-[#0a0a0a] border border-gray-100 dark:border-gray-800 overflow-hidden shadow-2xl flex-col"
            style={{
                borderRadius: 27,
                width: 372,
                minHeight: 560, // ⚡️ ADDED: Forces the card to always be nice and tall!
        ...
        >
            ...
            {/* ⚡️ FLEX-1 CONTAINER: Pushes the footer exactly to the bottom */}
            <View className="flex-1 justify-between w-full relative z-10">
                <View className="items-center w-full">

                    {/* ⚡️ THE PLAYER CARD TOP IDENTIFIER STRUCTURE */}
                    <View className="flex-row justify-between w-full items-center mb-6 opacity-40">
                    ...
                    {/* ⚡️ WRAPPED WITH PX-4: Ensures Nameplate can shrink if the clan name is too long! */}
                    <View className="flex-row items-center justify-center gap-1 mb-2 w-full px-4">
                ...
                {/* ⚡️ Footer pinned safely to the bottom */}
