...
export default function PeakBadge({ level = 1, size = 32 }) {
    ...
    if (totalRows === 1) scaleMultiplier = 1.25; // Massive single indicator
    else if (totalRows === 2) scaleMultiplier = 0.95; // Side by side or 2 rows
    else if (totalRows === 3) scaleMultiplier = 0.75; // Triangle + Chevron
