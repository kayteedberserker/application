        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: THEME.bg }}>
            ...
            <ScrollView className="flex-1 px-6" showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 60 }}>
                ...
                <Section
                    ...
                    content="We do not sell or distribute your personal data arrays to external applications, except as required by law or to maintain the safety of the Oreblogda network."
                />
