...
const WalletPage = () => {
    ...
    const handleClaimDaily = async () => {
        ...
        // extraData is null, clanTag is null
    ...
    const handlePurchase = async () => {
        ...
        // Find the RevenueCat package if it's a vault pack, otherwise use selectedPkg (store item)
        ...
        try {
            ...
            const result = await processTransaction(
                ...
                {
                    currency: coinType,
                    rewards: isPreviewingPack ? selectedPkg.rewards : null
                },
                userClan?.tag
            );
                                            ...
                                            <View className="flex-row justify-between items-start">
                                                <View className="flex-1 mr-4">
                                                    <View className="flex-row items-center mb-1">
                                                        <Text className="font-black text-2xl italic uppercase" style={{ color: isLocked ? THEME.textSecondary : THEME.text }}>{pack.name}</Text>
