      ...
      <ScrollView className="flex-1 px-6" showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 60 }}>
        ...
        >
          ...
          <Text style={{ color: THEME.textSecondary || '#64748b' }} className="text-xs leading-5 font-medium">
            "Aura Padding" via low-effort transmissions or automated comments is strictly forbidden. The system will trigger a <Text className="text-red-500 font-bold">RANK RESET</Text> for any player flagged by the integrity filters.
          </Text>
        </View>
