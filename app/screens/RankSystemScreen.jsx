      ...
      <ScrollView className="flex-1 px-6" showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 60 }}>
        ...
        <View className="mb-10">
            ...
            <View style={{ backgroundColor: THEME.card, borderColor: THEME.border }} className="p-6 rounded-[35px] border-2">
                ...
                <RankRow icon="💎" title="Elite_Writer" count={151} limit={4} />
                <RankRow icon="🔥" title="Senior_Writer" count={101} limit={4} />
                <RankRow icon="⚔️" title="Novice_Writer" count={51} limit={3} />
                <RankRow icon="📜" title="Senior_Researcher" count={26} limit={3} />
                <RankRow icon="🛡️" title="Novice_Researcher" count={0} limit={2} isLast />
            </View>
